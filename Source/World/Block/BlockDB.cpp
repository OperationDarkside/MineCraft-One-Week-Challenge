...
:   textureAtlas    ("DefaultPack")
{
    ...
    // Water
    Block block_water = {false, false, false, 1, 0, static_cast<BlockMeshType>(0), static_cast<BlockShaderType>(2), "Water", {8, 0}, {8, 0}, {8, 0}};
    ...
    Load("C:/Users/greis/Source/Repos/McClone-Fork/Res/Blocks/BlockDB.csv");
}
